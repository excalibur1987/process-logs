...
import { functionHeaders, functionLogs, functionProgress } from './schema';
...
export const functionProgressRelations = relations(functionProgress, ({ one, many }) => ({
...
export const functionHeadersRelations = relations(functionHeaders, ({ many }) => ({
	functionProgresses: many(functionProgress)
}));
